...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean useBackcamera = PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getBoolean("useBackcamera", false);
        cameraSwitch.setChecked(useBackcamera);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).edit().putBoolean("useBackcamera", cameraSwitch.isChecked()).apply();
